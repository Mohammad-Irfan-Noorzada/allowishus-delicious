...
function OrderCoffee() {
  return (
    <>
      <section className="flex flex-col-reverse md:flex-row items-center mt-10 pt-10 px-4 gap-6 bg-gradient-to-t to-neutral-ultraLightGray 
        ...
        <div className="max-w-[31.25rem] md:max-w-[21.875rem] lg:max-w-[28.125rem] xl:max-w-[32rem] text-center md:text-left space-y-4 md:space-y-6">
          ...
          <p className="text-[1.125rem] md:text-lg xl:text-2xl text-neutral-dimGray pb-5 md:pb-0 lg:pb-4">
            Freshly brewed aroma sits gently on your senses. Smooth textures blend with bold flavor to craft an experience beyond ordinary taste.
            Velvety warmth pours softly into each moment. Satisfaction rises slowly, like steam from the first morning cup.
          </p>

          <button className="uppercase py-4 lg:px-6 xl:px-7 rounded-[2.5rem] max-w-64 md:max-w-44 w-full 
