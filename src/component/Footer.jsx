          ...
          <div className="flex flex-col md:flex-row justify-between gap-14 md:gap-10">
            <div className="max-w-[28.125rem] md:max-w-[21.875rem] lg:max-w-[28.125rem] xl:max-w-[35rem] space-y-4 lg:space-y-8">
              ...
              <p className="sm:text-lg lg:text-[1.3rem] xl:text-3xl text-neutral-dimGray">
                We made it our mission to create community everyday and grow meaningful,
                lasting relationships with our staff, our suppliers and of course you, our customers.
              </p>
            </div>
            ...
            <div className="xl:max-w-[35rem] lg:max-w-[23.125rem] space-y-4 md:space-y-5 xl:space-y-6">
              ...
              <div className="flex gap-3 lg:gap-4 items-center">
                <img src="images/email.png" alt="email" className="p-1.5 md:p-2.5 bg-neutral-white rounded-full" />
                <p className="text-[1.1rem] md:text-[1.3rem] xl:text-[1.675rem] text-neutral-dimGray">alowishus@gmai.com</p>
              </div>

              <div className="flex gap-3 lg:gap-4 items-center">
                <img src="images/call.png" alt="phone" className="p-1 md:p-2 bg-neutral-white rounded-full" />
                <p className="text-[1.1rem] md:text-[1.3rem] xl:text-[1.675rem] text-neutral-dimGray">+110 214 214 2451</p>
              </div>
            ...
            <div className="flex flex-col md:flex-row justify-between gap-14 md:gap-10">
              <div className="max-w-[28.125rem] md:max-w-[21.875rem] lg:max-w-[28.125rem] xl:max-w-[35rem] space-y-3 lg:space-y-8">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <img src="images/arrow.png" alt="arrow" className="w-6"/>
                </div>
              </div>
