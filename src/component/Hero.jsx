    ...
    <>
      <section id="home" className="flex flex-col justify-between md:flex-row md:items-center text-center md:text-start pt-20 sm:pt-24 lg:pt-28 gap-16 
        ...
        <div className="max-w-[30rem] sm:max-w-[35rem] md:max-w-[32rem] mx-auto leading-tight 2xl:max-w-[40rem]">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center md:items-center lg:flex-row md:justify-start gap-4 mt-6 
            lg:gap-8 md:mt-8 lg:mt-10 xl:mt-16">
            <button className="py-3 lg:py-4 lg:px-6 xl:py-5 xl:px-8 rounded-[2.5rem] max-w-64 md:max-w-44 lg:max-w-52 xl:max-w-56 w-full 
            ...
            <a href="#" className="uppercase font-medium text-neutral-veryDarkGray border-b-2 border-b-neutral-dimGray lg:text-lg hover:text-neutral-dimGray
