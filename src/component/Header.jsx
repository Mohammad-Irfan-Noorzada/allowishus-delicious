  ...
  return (
    <>
      <header className="flex justify-between items-center gap-4 overflow-hidden 2xl:max-w-[100rem] 2xl:mx-auto">
        ...
        <div className={`md:hidden fixed top-0 bottom-0 left-0 right-0 h-screen w-screen bg-neutral-veryDarkGray transition-opacity duration-1000 z-10
        ...
        <nav className={`md:relative flex flex-col md:flex-row md:items-center gap-8 xl:gap-10 bg-neutral-veryLightGray md:bg-transparent pt-24 
          ...
          <div className="flex flex-col md:flex-row gap-6 lg:gap-4 items-center">
            ...
            <button className="text-center max-w-96 w-full lg:w-auto lg:text-left px-7 py-2 rounded-[2.5rem] text-neutral-white uppercase
