...
function DownloadApp() {
  return (
    <>
      <section className="relative flex flex-col-reverse md:flex-row items-center mt-10 pt-4 px-4 md:gap-6 bg-gradient-to-t to-neutral-ultraLightGray 
        ...
        <div className="max-w-[31.25rem] md:max-w-[21.875rem] lg:max-w-[28.125rem] xl:max-w-[32rem] text-center md:text-left space-y-4 md:space-y-6">
          ...
          <p className="text-[1.125rem] md:text-lg xl:text-2xl text-neutral-dimGray pb-5 md:pb-0 lg:pb-4">
            Instant coffee at home has never been this easy or satisfying. Just add hot water, stir, and enjoy bold, café-style
            flavor in seconds. Whether it's your morning ritual or a midday boost, great coffee is always within reach.
          </p>

          <button className="py-3 lg:py-4 lg:px-6 xl:py-5 xl:px-8 rounded-[2.5rem] max-w-64 w-full 
